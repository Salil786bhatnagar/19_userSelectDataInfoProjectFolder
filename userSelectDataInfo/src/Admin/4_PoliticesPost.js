...
import {postData,postDataAndImage,getData} from '../component/FetchNodeServices'
...
export default function PoliticesNewsData() {
    ...
    const handleClick=async(e)=>{
        ...
        var formData = new FormData();
             ...
             var result = await postDataAndImage('politice/insertPoliticesPost',formData,config)
  ...
  return (
    <div>
      <div>
          <h5 className='heading-container'>Politices Post</h5>
      </div>
       <br/><br/>
